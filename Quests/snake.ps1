...
#   if($whatDidIHit) {
#     #   write-buffer "game over - je raakte $whatDidIHit!" 0 ($playArea + 10)
#   }
...
function board {
  ...
  Write-Buffer "Speel het spel totdat je staart helemaal tot 10 is." 0 0
  $offset++
  $tempString = "GEBRUIK ALLEEN DE PIJLTJES "
  Write-Buffer $tempString 0 1
  $offset++
  $tempString = "Staart grootte: " + $global:numOfTails
...
while(1 -eq 1) {
  ...
  if ([console]::KeyAvailable) {
      $playerInput = [System.Console]::ReadKey('NoEcho') 
      switch ($playerInput.key) {
          ...
          Spacebar {
              ...
              [void][System.Console]::ReadKey('NoEcho')
